  ...
  return (
    <div className='lg:w-[28vw] md:w-[50vw] w-[90vw] flex flex-col p-4 px-8 border-2 border-gray-200 py-6 mt-6 rounded-2xl'>
       ...
       <form onSubmit={handlesubmit} className='flex flex-col gap-6 mt-3 w-full'>
          <CreateInput reference={nameRef} startIcon={<UserRound size={15} color="#99a1af"/>} required={true} type="text" label='Username' placeholder='Enter your username' tagType='input' className='h-[2.5rem] rounded-sm border-2 border-gray-100'/>
