  ...
  return (
    <div className='lg:w-[28vw] flex flex-col p-4 px-8 border-2 border-gray-200 py-6 mt-6 rounded-2xl'>
       ...
       <form className='flex flex-col gap-6 mt-3 w-full'>
          ...
          <CreateInput startIcon={<Mail size={15} color="#99a1af"/>} required={true} type="password" label='Password' placeholder='Enter your password' tagType='input' className='h-[2.5rem] focus-within:ring-2 focus-within:ring-primary rounded-sm border-2 border-gray-100'/>
